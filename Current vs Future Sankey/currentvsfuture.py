...
data = go.Sankey(
    node=dict(
        ...
        label=[
            "Current",
            "861 - Line 5/78",
            "107 - Quebec Waterborne Imports",
            "165 - Other Crude Oil Pipelines",
            "Future",
            "570 - Line 78",
            "308 - Quebec Waterborne Imports",
            "165 - Other Crude Oil Pipelines",
            "20 - Nanticoke Crude by Rail",
            "35 - Sarnia Crude by Rail",
            "35 - Toledo Crude by Rail",
        ],
